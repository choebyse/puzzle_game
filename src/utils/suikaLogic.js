export const FRUITS = [
  { name: '삽밥',  radius: 12,  color: '#74b9ff', score: 1,  image: '/faces/1_sabpap.png' },
  { name: '상호',  radius: 17,  color: '#55efc4', score: 3,  image: '/faces/2_sangho.png' },
  { name: '도준',  radius: 23,  color: '#a29bfe', score: 6,  image: '/faces/3_dojun.png' },
  { name: '양찌',  radius: 29,  color: '#ffeaa7', score: 10, image: '/faces/4_yangzzi.png' },
